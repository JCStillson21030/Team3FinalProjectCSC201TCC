/******************************************************************************
Jonathon Stillson CSC201 HW8 Problem 1 
INPUT AT LEAST TWELVE PERSONS FROM A FILE HAVING DATA ACCORDING TO THE ABOVE 
STRUCT.ENSURE THAT THE FILE CONTAINS PROPER VALUES FOR FATHER'S SSN AND MOTHER'S
SSN OF THE 12 (OR MORE) PERSONS. Among the twelve (or more) persons, find all 
the full siblings (persons having the same father and mother). For every set of
persons having the same parents, report the names of the parents and the names 
of the children with gender.  
*******************************************************************************/
...
int main()
{
    ...
    fauxPerson.open(fName);                         // opens the text file "fauxPerson.txt".
